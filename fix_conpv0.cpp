...
FixConpV0::FixConpV0(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp, narg, arg)
{
...
void FixConpV0::setup(int vflag)
{
...
//copied from ewald.cpp end
  ...
  memory->create3d_offset(cs,-kmax,kmax,3,nmax,"fixconpv0:cs");
  memory->create3d_offset(sn,-kmax,kmax,3,nmax,"fixconpv0:sn");
...
void FixConpV0::pre_force(int vflag)
{
...
int FixConpV0::electrode_check(int atomid)
{
...
void FixConpV0::a_cal()
{
  ...
  double **eleallx = NULL;
  memory->create(eleallx,elenum_all,3,"fixconpv0:eleallx");
  ...
  memory->create(csk,kcount,elenum_all,"fixconpv0:csk");
  memory->create(snk,kcount,elenum_all,"fixconpv0:snk");
  sincos_a(eleallx);
  delete [] elexyzlist;
...
void FixConpV0::sincos_a(double **eleallx)
{
  int i,m,k,ic;
  int kx,ky,kz;
  double ***csele,***snele;
  memory->create3d_offset(csele,-kmax,kmax,3,elenum_all,"fixconpv0:csele");
  memory->create3d_offset(snele,-kmax,kmax,3,elenum_all,"fixconpv0:snele");
...
/* ---------------------------------------------------------------------- */
void FixConpV0::force_cal(int vflag)
{
  int i;
...
/* ---------------------------------------------------------------------- */
void FixConpV0::coul_cal(int coulcalflag,double *m,int *ele2tag)
{
  Ctime1 = MPI_Wtime();
...
/* ---------------------------------------------------------------------- */
double FixConpV0::rms(int km, double prd, bigint natoms, double q2)
{
